 ...
 */
final class Version20220329050141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD town VARCHAR(255) NOT NULL');
    }
